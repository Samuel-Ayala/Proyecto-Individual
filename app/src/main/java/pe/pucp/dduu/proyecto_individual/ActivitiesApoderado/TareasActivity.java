...
public class TareasActivity extends AppCompatActivity {
                    ...
                    referenciaTareas.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                ListaTareasAdapter listaTareasAdapter = new ListaTareasAdapter(tareas, TareasActivity.this);
                                listarEnRV(listaTareasAdapter);
                            }else {
    ...
    public void listarEnRV(ListaTareasAdapter listaTareasAdapter)
    {
        RecyclerView rv = findViewById(R.id.recyclerTareas);
        rv.setAdapter(listaTareasAdapter);
        rv.setLayoutManager(new LinearLayoutManager(TareasActivity.this));
    }
}